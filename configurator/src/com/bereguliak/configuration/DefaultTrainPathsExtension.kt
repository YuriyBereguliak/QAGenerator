...
const val FILE_PLURAL_TRAIN_DATA = "plural-classifier-train.txt"
...
const val FILE_PLURAL_MODEL = "plural-classifier-model.maxent.gz"
...
fun getPluralTrainPath() = FILE_PLURAL_TRAIN_DATA.getTrainModelsFilePath()
//endregion
...
fun getPluralModelPath() = FILE_PLURAL_MODEL.getModelsFilePath()
//endregion

//region Utility API
private

fun String.getTrainModelsFilePath() = FOLDER_MODELS + File.separator + FOLDER_TRAIN + File.separator + this
